...
export const EXPECTED_COMMAND_NAMES = [
  ...
  'source', 'touch', 'rm', 'alias', 'export', 'grep', 'head', 'tail', 'wc',
  ...
  'ai',
  'seek', 'zoom', 'scroll', 'volume', 'audible', 'hints', 'links', 'link', 'shot',
  ...
  'bind', 'edit-bind', 'import-vimium-keys', 'bang', 'edit',
  'ps', 'top', 'kill', 'pkill', 'renice',
  'workspace', 'workview', 'split', 'layout',
] as const;
